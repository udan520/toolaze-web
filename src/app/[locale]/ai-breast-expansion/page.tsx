...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const pathWithoutLocale = '/ai-breast-expansion'
...
export default async function AiBreastExpansionLocalePage({ params }: PageProps) {
  ...
  if (locale === 'en') {
    redirect('/ai-breast-expansion')
  }

  if (!hasLocaleL2JsonFile('ai-breast-expansion', locale)) {
    redirect('/ai-breast-expansion')
  }

  return <ToolL2PageContent locale={locale} tool="ai-breast-expansion" />
}
