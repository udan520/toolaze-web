...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${commonT.allImageCompressionTools || 'All Image Compression Tools'} - ${breadcrumbT.imageCompression} | Toolaze`,
    description: commonT.allImageCompressionToolsDesc || 'Browse all available image compression tools. Find the perfect tool for your specific needs.',
    robots: 'index, follow',
    alternates: {
        ...
        <header className="bg-[#F8FAFF] pb-12 px-6">
          <div className="max-w-4xl mx-auto text-center pt-8 mb-12">
            <h1 className="text-[40px] font-extrabold tracking-tight mb-6 leading-tight text-slate-900">
              <span className="text-gradient">{commonT.allImageCompressionTools || 'All Image Compression Tools'}</span>
            </h1>
