...
import {
  getPromptDataManifest,
  getPromptItems,
  getPromptStats,
} from '@/lib/prompts'
import { loadCommonTranslations } from '@/lib/seo-loader'

const copy = getPromptIndexTranslations('en')
...
export default async function PromptsPage() {
  ...
  const commonTranslations = await loadCommonTranslations('en')
    ...
    <>
      ...
      <main className="min-h-screen bg-[#F8FAFF]">
        ...
        <PromptGallery
          ...
          copy={copy.gallery}
          categoryLabels={getPromptCategoryLabels('en')}
        />
      </main>
