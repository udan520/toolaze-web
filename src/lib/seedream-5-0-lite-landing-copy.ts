...
const localizedContentOverrides: Partial<Record<Seedream50LiteLocale, DeepPartial<Seedream50LiteLandingCopy>>> = {
  de: {
    ...
    related: {
      ...
      links: [
        ...
        { title: 'GPT Image 2', href: '/model/gpt-image-2-0', text: 'Erstellen Sie strukturierte Bilder, Mockups, Textgrafiken und Bearbeitungen.' },
  ...
  es: {
    ...
    related: {
      ...
      links: [
        ...
        { title: 'GPT Image 2', href: '/model/gpt-image-2-0', text: 'Crea imágenes estructuradas, mockups, gráficos con texto y ediciones.' },
  ...
  ja: {
    ...
    related: {
      ...
      links: [
        ...
        { title: 'GPT Image 2', href: '/model/gpt-image-2-0', text: '構造化画像、モックアップ、文字中心のグラフィック、編集画像を作成します。' },
  ...
  pt: {
    ...
    related: { title: 'Modelos AI relacionados', tryNow: 'Testar agora', links: [{ title: 'Seedream 4.5', href: '/model/seedream-4-5', text: 'Use o fluxo Seed atual para produtos 4K, pôsteres e edição com referências.' }, { title: 'GPT Image 2', href: '/model/gpt-image-2-0', text: 'Crie imagens estruturadas, mockups, gráficos com texto e edições.' }, { title: 'Wan 2.7 Image', href: '/model/wan-2-7-image', text: 'Teste thinking mode, múltiplas referências e layouts de pôster.' }] },
  ...
  'zh-TW': {
    ...
    related: {
      ...
      links: [
        ...
        { title: 'GPT Image 2', href: '/model/gpt-image-2-0', text: '建立結構化圖像、mockup、文字主導圖形與編輯視覺。' },
  ...
  fr: {
    ...
    related: { title: 'Modèles AI associés', tryNow: 'Essayer', links: [{ title: 'Seedream 4.5', href: '/model/seedream-4-5', text: 'Utilisez le workflow Seed actuel pour produits 4K, affiches et édition par référence.' }, { title: 'GPT Image 2', href: '/model/gpt-image-2-0', text: 'Créez des images structurées, mockups, visuels avec texte et éditions.' }, { title: 'Wan 2.7 Image', href: '/model/wan-2-7-image', text: 'Testez thinking mode, références multiples et layouts d’affiche.' }] },
  ...
  ko: {
    ...
    related: { title: '관련 AI 이미지 모델', tryNow: '지금 사용', links: [{ title: 'Seedream 4.5', href: '/model/seedream-4-5', text: '현재 Seed 워크플로로 4K 제품 이미지, 포스터, 참조 편집을 만듭니다.' }, { title: 'GPT Image 2', href: '/model/gpt-image-2-0', text: '구조화 이미지, 목업, 텍스트 그래픽, 편집 이미지를 만듭니다.' }, { title: 'Wan 2.7 Image', href: '/model/wan-2-7-image', text: 'thinking mode, 다중 참조, 구조화 포스터 레이아웃을 시도합니다.' }] },
  ...
  it: {
    ...
    related: { title: 'Modelli AI correlati', tryNow: 'Prova ora', links: [{ title: 'Seedream 4.5', href: '/model/seedream-4-5', text: 'Usa il workflow Seed attuale per prodotti 4K, poster ed editing con riferimenti.' }, { title: 'GPT Image 2', href: '/model/gpt-image-2-0', text: 'Crea immagini strutturate, mockup, grafiche con testo ed editing.' }, { title: 'Wan 2.7 Image', href: '/model/wan-2-7-image', text: 'Prova thinking mode, riferimenti multipli e layout poster.' }] },
