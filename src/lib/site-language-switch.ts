...
export const TOOL_SUPPORTED_LOCALES: Record<string, readonly string[]> = {
  ...
  'talking-avatar-creator': ALL_LOCALE_CODES,
  'ai-dance-generator': ALL_LOCALE_CODES,
  'ai-clothes-changer': ALL_LOCALE_CODES,
  'ai-bikini-generator': ALL_LOCALE_CODES,
  'ai-breast-expansion': ALL_LOCALE_CODES,
  'unrestricted-ai-image-generator': ALL_LOCALE_CODES,
...
const MODEL_SUPPORTED_LOCALES: Record<string, readonly string[]> = {
  ...
  'veo-3-1-ai-video-generator': ALL_LOCALE_CODES,
  'happyhorse-ai-video-generator': ALL_LOCALE_CODES,
  'wan-2-7-ai-video-generator': ALL_LOCALE_CODES,
  'wan-2-6-ai-video-generator': ALL_LOCALE_CODES,
  'wan-2-5-ai-video-generator': ALL_LOCALE_CODES,
  'pixverse-v6-ai-video-generator': ALL_LOCALE_CODES,
