...
export const VIDEO_MODEL_L2S = ['wan-3-0-ai-video-generator', 'veo-3-1-ai-video-generator', 'happyhorse-ai-video-generator', 'kling-3-motion-control', 'pixverse-v6-ai-video-generator', 'wan-2-7-ai-video-generator', 'wan-2-6-ai-video-generator', 'wan-2-5-ai-video-generator', 'seedance-2-5', 'seedance-2', 'kling-3', 'kling-2-6-pro-motion-control', 'grok-imagine-video-1-5']
  ...
  try {
    ...
    try {
      if (tool === 'font-generator') {
        ...
        data = await importL2FlatJson('wan-2-7-ai-video-generator', normalizedLocale)
      } else if (tool === 'wan-3-0-ai-video-generator') {
        data = await importL2FlatJson('wan-3-0-ai-video-generator', normalizedLocale)
      } else if (tool === 'wan-2-6-ai-video-generator') {
        data = await importL2FlatJson('wan-2-6-ai-video-generator', normalizedLocale)
      ...
      } else if (tool === 'kling-3-motion-control') {
        data = await importL2FlatJson('kling-3-motion-control', normalizedLocale)
      ...
      } else if (tool === 'ai-dance-generator') {
      ...
      } else if (tool === 'talking-avatar-creator') {
        data = await importL2FlatJson('talking-avatar-creator', normalizedLocale)
      ...
      } else if (tool === 'age-filter') {
        data = await importL2FlatJson('age-filter', normalizedLocale)
      ...
      if (normalizedLocale !== 'en') {
        try {
          if (tool === 'font-generator') {
            ...
            data = await import('@/data/en/wan-2-7-ai-video-generator.json')
          } else if (tool === 'wan-3-0-ai-video-generator') {
            data = await import('@/data/en/wan-3-0-ai-video-generator.json')
          } else if (tool === 'wan-2-6-ai-video-generator') {
            data = await import('@/data/en/wan-2-6-ai-video-generator.json')
          } else if (tool === 'wan-2-5-ai-video-generator') {
            ...
            data = await import('@/data/en/kling-3-motion-control.json')
          } else if (tool === 'kling-2-6-pro-motion-control') {
            ...
            data = await import('@/data/en/talking-avatar-creator.json')
          } else if (tool === 'ai-baby-generator') {
            ...
            data = await import('@/data/en/age-filter.json')
          } else if (tool === 'ai-hair-color-changer') {
...
export async function getAllSlugs(tool: string, locale: string = 'en'): Promise<string[]> {
  try {
    ...
    if (tool === 'nano-banana-pro' || tool === 'nano-banana-2' || tool === 'gpt-image-2') {
      return [];
    }
    return [];
  } catch (error) {
