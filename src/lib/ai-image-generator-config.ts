...
interface AiImageGeneratorModelConfig {
  ...
  imageToImageAspectRatioMode: 'custom' | 'reference-image'
  maxImages: number
...
export const AI_IMAGE_GENERATOR_MODELS = {
  'nano-banana-pro': {
    ...
    imageToImageAspectRatioMode: 'custom',
    maxImages: 8,
    maxFileSizeMb: 30,
  ...
  'nano-banana-2-lite': {
    ...
    description: 'Fast Nano Banana 2 workflow for lightweight drafts and everyday image edits.',
    qualityRating: 4,
    badge: 'New',
    vendor: 'Google',
    aspectRatios: ratios('auto', '1:1', '1:4', '1:8', '2:3', '3:2', '3:4', '4:1', '4:3', '4:5', '5:4', '8:1', '9:16', '16:9', '21:9'),
    ...
    supportsHighResolution: false,
    defaultMode: 'image-to-image',
    setting: { kind: 'resolution', options: ['1K'], defaultValue: '1K' },
  },
  'gpt-image-2': {
    name: 'GPT Image 2',
    ...
    badge: 'Hot',
    vendor: 'OpenAI',
    aspectRatios: ratios('auto', '1:1', '3:2', '2:3', '4:3', '3:4', '5:4', '4:5', '16:9', '9:16', '2:1', '1:2', '3:1', '1:3', '21:9', '9:21'),
    imageToImageAspectRatioMode: 'custom',
    maxImages: 16,
    maxFileSizeMb: 30,
  ...
  'grok-1-5-image': {
    ...
    badge: 'New',
    vendor: 'xAI',
    aspectRatios: ratios('1:1', '2:3', '3:2', '16:9', '9:16'),
    imageToImageAspectRatioMode: 'reference-image',
    maxImages: 1,
    maxFileSizeMb: 10,
    supportsOutputFormat: false,
    supportsHighResolution: false,
  ...
  'grok-video-1-5': {
    ...
    badge: 'New',
    vendor: 'xAI',
    aspectRatios: ratios('auto', '1:1', '16:9', '9:16', '3:2', '2:3'),
    imageToImageAspectRatioMode: 'custom',
    maxImages: 7,
    maxFileSizeMb: 20,
    supportsOutputFormat: false,
  ...
  'wan-2-7-image': {
    ...
    qualityRating: 4,
    vendor: 'Wan AI',
    aspectRatios: ratios('1:1', '16:9', '4:3', '21:9', '3:4', '9:16', '8:1', '1:8'),
    imageToImageAspectRatioMode: 'custom',
    maxImages: 9,
    maxFileSizeMb: 10,
    supportsOutputFormat: false,
...
export const AI_IMAGE_GENERATOR_GROUPS: AiImageGeneratorGroup[] = [
  ...
  },
  {
    ...
    modelIds: ['nano-banana-pro', 'nano-banana-2', 'nano-banana-2-lite'],
  },
  {
    id: 'xai',
    name: 'xAI',
