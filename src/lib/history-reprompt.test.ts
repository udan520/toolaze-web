...
test('restores Seedance video, audio, image, and output settings for Recreate', () => {
  const item = {
    ...
    inputUrls: [
      ...
      'https://assets.toolaze.com/uploads/reference-video.mp4',
      'https://assets.toolaze.com/uploads/reference-audio.mp4',
    ],
    outputFormat: JSON.stringify({
      ...
      referenceVideoUrls: ['https://assets.toolaze.com/uploads/reference-video.mp4'],
      referenceAudioUrls: ['https://assets.toolaze.com/uploads/reference-audio.mp4'],
      webSearch: true,
    }),
  }
