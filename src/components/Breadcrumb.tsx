...
export default function Breadcrumb({ items, variant = 'page' }: BreadcrumbProps) {
  ...
  const LOCALE_LESS_PATHS = ['/model', '/model/seedance-2-5', '/model/seedance-2', '/model/kling-3', '/model/kling-2-6-pro-motion-control', '/model/nano-banana-pro', '/model/nano-banana-2', '/model/gpt-image-2', '/model/seedream-4-5', '/model/seedream-5-0-lite', '/model/seedream-5-0-pro', '/model/wan-2-7-image']
