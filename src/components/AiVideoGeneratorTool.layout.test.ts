...
test('AI video generator uses the shared generation history API for completed videos', () => {
  ...
  assert.match(source, /persistGeneratedVideoHistoryItem\(completedRequest, videoUrl, \[\.\.\.imageUrls, \.\.\.uploadedMotionVideoMedia\.historyUrls\]/, 'shared history should persist the actual displayable reference image or first/last-frame resources and motion video')
