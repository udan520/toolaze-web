  ...
  return (
    <div data-motion-reference-video-uploader className="rounded-2xl border border-[#E0E7FF] bg-[#F8FAFF] p-3">
      ...
      {selectedVideo ? (
        ...
        >
          <video src={selectedVideo.src} poster={selectedVideo.poster} className="absolute inset-0 h-full w-full object-contain object-center" muted playsInline preload="metadata" />
