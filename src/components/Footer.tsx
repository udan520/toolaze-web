        ...
        <div className="grid grid-cols-1 gap-8 mb-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 mt-4">
              ...
              <li>
                <Link
                  href={getLocalizedHref('/age-filter')}
                  className="text-slate-400 hover:text-indigo-400 transition-colors text-sm block pl-4"
                >
                  {translations.ageFilter || 'AI Age Filter'}
                </Link>
              </li>
              <li>
                <Link
          ...
          <div>
            ...
            <ul className="space-y-2 mt-4">
              ...
              <li>
                <Link
                  href={getLocalizedHref('/model/wan-3-0-ai-video-generator')}
                  className="text-slate-400 hover:text-indigo-400 transition-colors text-sm block pl-4"
                >
                  {translations.wan30Video || 'Wan 3.0 Video'}
                </Link>
              </li>
              <li>
                <Link
              ...
              <li>
                <Link
                  ...
                  className="text-slate-400 hover:text-indigo-400 transition-colors text-sm block pl-4"
                >
                  {translations.wan25Video || 'Wan 2.5 Video'}
                </Link>
              </li>
              <li>
                <Link
