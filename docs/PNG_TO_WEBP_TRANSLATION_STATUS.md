# PNG to WebP Converter 页面翻译状态报告
...
- **工具**: Image Converter
- **Slug**: `png-to-webp`
- **文件路径**: `src/data/{lang}/image-converter/png-to-webp.json`
- **菜单显示**: `in_menu: true`
...
使用脚本 `scripts/check-png-to-webp-translations.js` 检查所有语言的翻译完整性。
...
- 技术术语（如 "Canvas API", "Client-Side", "WebP"）在翻译中保持英文，符合技术文档规范
