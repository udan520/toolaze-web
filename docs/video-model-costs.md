...
| --- | --- | --- | ---: | --- | --- |
| Talking Avatar Creator / Infinitalk | `infinitalk` | Other | 6+ credits | 480p × 1秒 | 音频驱动唇同步；无独立加价表 |
...
| --- | --- | --- | --- | --- |
| Talking Avatar Creator / Infinitalk | `infinitalk` | 按秒 | 480p: 6/s<br>720p: 24/s | 无独立加价表 |
...
| Talking Avatar Creator / Infinitalk | 480p | $0.0150/s | 6/s | $0.0300/s | 50.0% | 50.0% |
| Talking Avatar Creator / Infinitalk | 720p | $0.0600/s | 24/s | $0.1200/s | 50.0% | 50.0% |
...
| --- | --- | --- |
| Talking Avatar Creator / Infinitalk | KIE pricing API：MeiGen-AI InfiniteTalk，480p $0.015/s，720p $0.06/s | `VIDEO_GENERATION_CREDIT_RATES['infinitalk']` |
